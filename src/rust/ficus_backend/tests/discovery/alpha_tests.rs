...
pub fn alpha_simple_test_1() {
    execute_alpha_discovery_test("alpha_simple_test_1", || create_simple_event_log3());
}
...
pub fn alpha_plus_plus_nfc_test_1() {
    execute_alpha_plus_plus_nfc_discovery_test("alpha_plus_plus_nfc_test_1", || create_alpha_plus_plus_nfc_test_log9());
}
